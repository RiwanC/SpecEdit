...
/*package*/ class PostfixOpNode_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PostfixOpNode_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_aads8q_a");
  ...
  private EditorCell createContextAssistant_0() {
    ...
    editorCell.setCellId("ContextAssistant_aads8q_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.PostfixOp$R0Q0;
